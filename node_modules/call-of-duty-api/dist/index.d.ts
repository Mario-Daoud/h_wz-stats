...
declare class WZ {
    ...
    combatHistoryWithDate: (gamertag: string, startTime: number, endTime: number, platform: platforms) => Promise<any>;
    breakdown: (gamertag: string, platform: platforms) => Promise<any>;
    breakdownWithDate: (gamertag: string, startTime: number, endTime: number, platform: platforms) => Promise<any>;
...
declare class SHOP {
    ...
    battlePassLoot: (title: games, season: number, platform: platforms) => Promise<any>;
}
declare class USER {
    ...
    friendAction: (gamertag: string, platform: platforms, action: friendActions) => Promise<any>;
}
declare class ALT {
